...

                    {
                        props.isDetail ? (
                            <Box sx={{overflow: 'auto'}}>
                                {
                                    props.content.sections.sort((a, b) => a.order - b.order).map(
                                        (item, index) => (
                                                        ...
                                                        <>
                                                            <div style={{
                                                                ...
                                                                }
                                                                {
                                                                    section.title && (
                                                                    <Button
                                                                    onClick={() => (props.setSection && item.section_contents) && props.setSection(item.section_contents[index])}>  {section.title}</Button>
                                                                    )
                                                                }
                                                            </div>
                                                        </>
